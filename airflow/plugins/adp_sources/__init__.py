...
To add a new source:
  1. Write a class in this package implementing BaseADPScraper (see fantasypros.py).
...
from adp_sources.fantasypros import FantasyProsSource

REGISTERED_SOURCES = [FantasyProsSource()]
